...
function EditOfficer() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://armoury-backend-ti9n.onrender.com/api/officers/${id}`)
            .then(response => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Update officer data
        axios.put(`https://armoury-backend-ti9n.onrender.com/api/officers/edit/${id}`, formData)
            .then(response => {
    ...
    if (!officer) {
        return <div>Loading...</div>; // Loading state until officer data is fetched
    }
    ...
    <h3 className="text-white mb-4 border-bottom border-light pb-3">Add New Officer</h3>
         ...
         <div className="row">
            <div className="col-md-11 m-auto new-weapon p-4">
                ...
                <button  type="submit" className="g-btn px-4 mt-3">
                    Update Officer
                </button>
            </Form>
            </div>
